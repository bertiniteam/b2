...
namespace client
{
    ...
    class Node
    {
     using smartptr = boost::shared_ptr<Node>;   
    ...
    public:
        ...
        std::string op_;
        std::vector<smartptr> leaves;
        bool isVar_ = false;
        
        
        void addLeaf(smartptr leaf);
    ...
    void Node::addLeaf(smartptr leaf)
    {
    ...
    template<typename Iterator>
    struct polynomial : qi::grammar<Iterator,smartptr(),ascii::space_type>
    {
        ...
        polynomial() : polynomial::base_type(sumexpr)
        {
            ...
            sumexpr = eps[_val = phx::construct<std::unique_ptr<Node>>("sum")]; //>>
//            eps[phx::bind(&Node::addLeaf,_val,std::unique_ptr<Node>("null"))] //>>
...
//             -('^' >> qi::int_[phx::bind(&Node::setop,_val,_1)]) );
        ...
        qi::rule<Iterator,smartptr(),ascii::space_type> sumexpr;
