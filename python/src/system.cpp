...
namespace bertini{
	namespace python{
		...
		void ExportSystem()
		{
			class_< bertini::System, std::shared_ptr<bertini::System> >("System", init<optional< std::string const& > >())
			...
			.def("jacobian", sysJac3<dbl>)
			.def("time_derivative", &System::TimeDerivative<dbl>)
			...
			.def("num_natural_variables", &System::NumNaturalVariables)
			...
			.def("aff_hom_ung_variable_ordering", &System::AffHomUngVariableOrdering)
			.def("FIFO_variable_ordering", &System::FIFOVariableOrdering)
			.def("set_aff_hom_ung_variable_ordering", &System::SetAffHomUngVariableOrdering)
			.def("set_FIFO_variable_ordering", &System::SetFIFOVariableOrdering)
			.def("variables", &System::Variables)
			.def("dehomogenize_point_dbl", sysDehom<dbl>)
			
			.def("function", &System::Function)
			.def("variable_groups", &System::VariableGroups)
			.def("coefficient_bound", &System::CoefficientBound)
			.def("degree_bound", &System::DegreeBound)
			.def("degrees", sysDeg1)
			.def("degrees", sysDeg2)
