...
max_precision = multiprec.max_precision
...
from .records import (solve, save, load, annotate, solutions_of, provenance,
                      recording, records_dir, runs, tracks, crossing_checks,
                      provenance_graph, plot_chain, Solution, SolveResult, ZeroDimResult)
from . import records
...
__all__ = ['solve','save','load','annotate','solutions_of','provenance','recording','records_dir','runs','tracks','crossing_checks','provenance_graph','plot_chain','Solution','SolveResult','ZeroDimResult','records',
