...
| [0046](0046-solver-records-seam-ensure-answered.md) | The solver records seam: solve() is ensure-answered — track records ARE serialized FullPathResults, hydration replays them through StoreFullPathResult, manager is sole writer, resume = memoization | Core / records |
