...
//  calls per-tracker-family registration functions (defined in split files).
//  No heavy endgame/algorithm headers needed here: only void functions are called by name.
